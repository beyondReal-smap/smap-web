    ...
    <>
        ...
        <div className="container mx-auto px-4 sm:px-6">
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8">
            <div>
              ...
              <p className="text-gray-600 mb-4 text-sm sm:text-base leading-relaxed">자녀의 위치와 일정을 확인하는 가장 신뢰할 수 있는 서비스</p>
              <div className="flex space-x-4">
                <a href="javascript:void(0)" className="text-blue-500 hover:text-blue-700">
            ...
            <div>
              <h3 className="text-lg font-semibold mb-4 text-blue-600">서비스</h3>
              <ul className="space-y-2 text-sm sm:text-base">
                <li><Link href="/features" className="text-gray-600 hover:text-blue-600">주요 기능</Link></li>
                <li><Link href="javascript:void(0)" className="text-gray-600 hover:text-blue-600">요금제</Link></li>
                <li><Link href="javascript:void(0)" className="text-gray-600 hover:text-blue-600">앱 다운로드</Link></li>
              </ul>
            </div>
            <div>
              ...
              <ul className="space-y-2 text-sm sm:text-base">
                ...
                <li><Link href="javascript:void(0)" className="text-gray-600 hover:text-blue-600">FAQ</Link></li>
                <li><Link href="javascript:void(0)" className="text-gray-600 hover:text-blue-600">도움말</Link></li>
              </ul>
            </div>
            <div>
              <h3 className="text-lg font-semibold mb-4 text-blue-600">이용약관</h3>
              <ul className="space-y-2 text-sm sm:text-base">
                <li><Link href="javascript:void(0)" className="text-gray-600 hover:text-blue-600">서비스이용약관</Link></li>
                <li><Link href="javascript:void(0)" className="text-gray-600 hover:text-blue-600">개인정보처리방침</Link></li>
                <li><Link href="javascript:void(0)" className="text-gray-600 hover:text-blue-600">위치기반서비스이용약관</Link></li>
              </ul>
            </div>
          </div>
          <div className="border-t border-blue-100 mt-12 pt-8 text-center text-gray-500">
            ...
            <p className="text-xs sm:text-sm">Copyright ⓒ 2024 SMAP All rights reserved.</p>
          </div>
        </div>
      </footer>
      ...
      <div className="qr-popup" ref={qrPopupRef} style={{ width: "300px" }}>
        <div className="text-center">
          ...
          <p className="text-sm text-gray-600 mb-4">QR코드를 스캔하여 SMAP앱을 다운로드 하세요.<br /><br /></p>
